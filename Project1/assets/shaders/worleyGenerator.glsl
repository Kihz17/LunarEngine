...
layout (rgba8, binding = 0) uniform image3D uWorleyTexture;

// Taken from https://github.com/NadirRoGue/RenderEngine/tree/master/RenderEngine/RenderEngine/shaders/clouds/generation
